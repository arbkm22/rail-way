// Station coordinates for Indian Railway stations
// Approximate coordinates for major junctions
...
function getStationCoordinates(stationName) {
    return STATION_COORDINATES[stationName] || null;
}

// Get all station names
function getAllStations() {
    return Object.keys(STATION_COORDINATES);
}
